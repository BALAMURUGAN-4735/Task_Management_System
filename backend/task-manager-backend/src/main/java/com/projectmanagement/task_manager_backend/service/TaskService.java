...
public class TaskService {
    ...
    // --- NEW / FIXED: Specific method for Employees to fetch only their assigned tasks ---
    public List<TaskDto> getTasksForEmployee(UUID employeeId) {
        return taskRepository.findByAssignedUserId(employeeId)
                .stream()
                .map(this::mapToDto)
                .collect(Collectors.toList());
    }
    ...
    public TaskDto createTask(TaskRequest request) {
        ...
        TaskDto taskDto = mapToDto(savedTask);
        
        messagingTemplate.convertAndSend("/topic/task-updates", taskDto);
    ...
    public TaskDto updateTask(UUID id, TaskRequest request) {
        ...
        TaskDto taskDto = mapToDto(updated);
    ...
    public void deleteTask(UUID id) {
        ...
        messagingTemplate.convertAndSend("/topic/task-updates", id.toString());
