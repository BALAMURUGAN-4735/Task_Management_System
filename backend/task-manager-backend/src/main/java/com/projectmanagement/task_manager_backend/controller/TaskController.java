...
public class TaskController {
    ...
    // --- ADDED: Employee specific task fetch API ---
    @GetMapping("/employee/{employeeId}")
    public ResponseEntity<ApiResponse<List<TaskDto>>> getTasksForEmployee(@PathVariable UUID employeeId) {
        return ResponseEntity.ok(new ApiResponse<>(true, "Employee tasks retrieved successfully", taskService.getTasksForEmployee(employeeId)));
    }
